...
var logger = require('juttle/lib/logger').getLogger('elastic-query');
...
function aggregation_fetcher(client, filter, query_start, query_end, options) {
    ...
    function fetcher() {
        ...
        .then(function(response) {
            ...
            var aggr_points = juttle_utils.toNative(aggregation.points_from_es_aggr_resp(response, aggregations));
