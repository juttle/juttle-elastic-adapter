...
var logger = JuttleAdapterAPI.getLogger('elastic-insert');
...
EventsInserter.prototype.end = function() {
    ...
    .then(() => {
        return this.client.bulkAsync({
            index: '', // aws-es2 demands index/type which is totally meaningless here
            type: '',
            body: this.events
        });
    })
    .then(function(response) {
        ...
        // aws-es2 returns an object while official ES client returns an array
